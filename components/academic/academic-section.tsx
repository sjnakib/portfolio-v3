      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <SkillCategory 
            ...
            skills={["Data Structures & Algorithms", "Statistical Analysis", "Machine Learning", "NLP", "Computer Vision"]}
          />
          <SkillCategory 
            title="Research & Development" 
            skills={["Experimental Design", "Literature Review", "Technical Writing", "Peer Review", "Prototyping"]}
          />
          <SkillCategory 
